...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(lambda: self.testProcess(target = 
            internet.Test, args = 
            (self.check_download.isChecked(), self.check_ping.isChecked(),self.check_upload.isChecked(), self.spinBox.value())).start())

        self.pushButton_2.clicked.connect(self.testProcess.terminate)

    def stopTest(self):
        print(self.testProcess.is_alive(self))
